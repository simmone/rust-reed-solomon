...
lazy_static! {
    static ref PRIMITIVE_POLY_TABLE: HashMap<u64, &'static str> = {
        HashMap::from([
            (7, "x2+x1+1"),
            (11, "x3+x1+1"),
            (19, "x4+x1+1"),
...
pub fn get_field_generator_poly_by_value(value: u64) -> &'static str {
    PRIMITIVE_POLY_TABLE.get(&value).unwrap()
}
...
mod tests {
    ...
    #[test]
    fn test_get_field_generator_poly_by_value() {
        assert_eq!("x4+x1+1", get_field_generator_poly_by_value(19));
    }
}
