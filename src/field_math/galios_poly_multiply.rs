...
mod tests {
    ...
    fn test_galios_poly_multiply() {
        assert_eq!("x", galios_poly_multiply(vec!["1", "x"], "x4+x+1"));
        assert_eq!(
            "x6+x5+x4+x",
        ...
        assert_eq!(
            "x4+15x3+3x2+x+12",
            galios_poly_multiply(vec!["x3+7x2+14x+8", "x+8"], "x4+x+1")
        );
        assert_eq!(
            "x6+x5+x4+x",
            galios_poly_multiply(vec!["x3+x", "x3+x2+1"], "x4+x+1")
        ...
        assert_eq!(
            "x8+x7+x6+x3",
            galios_poly_multiply(vec!["x4+x2+x+1", "x3+x4"], "x4+x+1")
        );
        assert_eq!(
            "x4+15x3+3x2+x+12",
            galios_poly_multiply(vec!["x+1", "x+2", "x+4", "x+8"], "x4+x+1")
        );
    }
}
