...
mod tests {
    ...
    fn test_galios_num_multiply() {
        assert_eq!(1, galios_num_multiply(10, 12, "x4+x+1"));
        assert_eq!(11, galios_num_multiply(10, 13, "x4+x+1"));
        assert_eq!(11, galios_num_multiply(14, 14, "x4+x+1"));
        assert_eq!(5, galios_num_multiply(14, 15, "x4+x+1"));
        assert_eq!(10, galios_num_multiply(3, 6, "x4+x+1"));
        assert_eq!(2, galios_num_multiply(1, 2, "x4+x+1"));
        assert_eq!(0, galios_num_multiply(0, 0, "x4+x+1"));
        assert_eq!(0, galios_num_multiply(0, 15, "x4+x+1"));
        assert_eq!(0, galios_num_multiply(15, 0, "x4+x+1"));
    }
}
